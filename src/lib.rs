...
pub mod jit;
pub use jit::{
    is_jit_eligible, is_numeric_stack_eligible, jit_call_builtins_ok, try_compile,
    try_compile_numeric_expr, try_jit_dispatch_numeric_chunk, try_jit_execute, JitChunk,
    JitNumericChunk, JitRuntimeState,
};
#[allow(dead_code)]
mod interp;
mod lexer;
