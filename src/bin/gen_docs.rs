...
const CHAPTERS: &[Chapter] = &[
    ...
    Chapter {
        ...
        names: &["sin", "cos", "atan2", "exp", "log", "sqrt", "int", "rand", "srand"],
    },
    Chapter {
    ...
    Chapter {
        ...
        names: &[
            "NR", "NF", "FS", "OFS", "ORS", "RS", "FILENAME", "FNR", "RSTART", "RLENGTH", "SUBSEP",
            "ARGC", "ARGV", "ENVIRON", "CONVFMT", "OFMT", "IGNORECASE", "FIELDWIDTHS", "FPAT",
            "PROCINFO", "RT", "ERRNO", "TEXTDOMAIN", "BINMODE", "LINT",
        ],
    },
    Chapter {
        ...
        names: &[
            ...
            "break", "continue", "next", "nextfile", "exit", "return", "delete", "switch", "case",
            "default", "in",
        ],
    },
];
